...
// src/templates/.claude/hooks/compliance/worktree-boundary-enforcer.ts
...
// src/templates/.claude/hooks/compliance/worktree-boundary-enforcer.ts
init_path_resolver();
function isPathInsideBoundary(filePath, boundary) {
  const normalizedBoundary = path5.resolve(boundary).replace(/[/\\]+$/, "");
  let normalizedFilePath;
  if (path5.isAbsolute(filePath)) {
    normalizedFilePath = path5.resolve(filePath);
  } else {
    normalizedFilePath = path5.resolve(resolveProjectRoot(), filePath);
  }
  const relativePath = path5.relative(normalizedBoundary, normalizedFilePath);
  const isInside = !relativePath.startsWith("..") && !path5.isAbsolute(relativePath);
  return isInside;
}
function formatBlockMessage(boundary, attemptedPath) {
  const red = "\x1B[31m";
...
${red}\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
`;
  output += `WORKTREE BOUNDARY VIOLATION
`;
  output += `\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501${reset}

`;
  output += `${white}You are working in worktree:${reset}
`;
  output += `  ${cyan}${boundary}${reset}

`;
  output += `${white}Attempted file path:${reset}
`;
  output += `  ${red}${attemptedPath}${reset}

`;
  output += `${yellow}The file is OUTSIDE your worktree boundary.${reset}

`;
  output += `${white}To edit files in the main repo:${reset}
`;
  output += `  ${cyan}Say: "edit main repo" or "work in main repo"${reset}
`;
  output += `  ${cyan}Or set: CLAUDE_WORKTREE_BOUNDARY=ignore${reset}
  ...
  void (async () => {
    try {
      ...
      if (!["Edit", "Write"].includes(toolName)) {
        logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
          details: `Tool ${toolName} is not Write/Edit, allowing`,
          status: "success"
        });
        outputAllow();
        exitSuccess();
      }
      if (process.env.CLAUDE_WORKTREE_BOUNDARY === "ignore") {
        logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
          details: "Worktree boundary enforcement bypassed via CLAUDE_WORKTREE_BOUNDARY=ignore",
          status: "success"
        });
        outputAllow();
        exitSuccess();
      ...
      const worktreeBoundary = state.worktreeBoundary;
      if (worktreeBoundary === void 0 || worktreeBoundary === "") {
        logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
          details: "No worktree boundary set, allowing operation",
          status: "success"
        });
        outputAllow();
        exitSuccess();
      ...
      if (filePath === "") {
        logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
          details: "No file_path in tool input, allowing",
          status: "success"
        });
        outputAllow();
        exitSuccess();
      }
      if (isPathInsideBoundary(filePath, worktreeBoundary)) {
        logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
          details: `Allowed: ${filePath} is inside worktree boundary ${worktreeBoundary}`,
          status: "success"
        });
        outputAllow();
        exitSuccess();
      ...
      logHookActivity("worktree-boundary-enforcer", "PreToolUse", {
        details: `Blocked: ${filePath} is outside worktree boundary ${worktreeBoundary}`,
        status: "blocked"
      });
      const response = {
        hookSpecificOutput: {
          block: {
            reason: formatBlockMessage(worktreeBoundary, filePath)
          },
      ...
      console.error("Worktree boundary enforcer hook error:", errorMessage);
      outputAllow();
      exitSuccess();
    }
  })();
