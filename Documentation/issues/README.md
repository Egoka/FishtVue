...
- [ ] **W6 — emits-guard:** `emitsNaming.test.ts` без `PENDING` — ✅ сделано в W5; осталось §6 всех доков и dev-patterns §7 финал.
