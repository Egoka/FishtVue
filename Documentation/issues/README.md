...
- [ ] **Codemods для breaking changes:**
  - [x] `Aria` → `Textarea` (rename + import-update, **без** deprecated-алиаса — решение R6) · [textarea.md Issue 6](./textarea.md) · ✅ resolved 2026-09-06
  ...
  - [x] `change:modelValue` type для Textarea/TextEditor · [textarea.md Issue 1](./textarea.md) · ✅ resolved 2026-05-11
- [ ] [CHANGELOG.md](../../CHANGELOG.md) (auto-gen) — documentation для каждого breaking change.
- [x] [Documentation/migration-guide.md](../migration-guide.md) — пошаговый guide для major-bumps (§1–§8 · 2026-09-06; §9–§15 по props 1.0 — Wave 13 / W8). Codemod-пакет — после 1.0.0 (R8).
...
- [ ] **W8 — документация и миграция:** migration-guide §9–§15 с `rg`-рецептами, closure-progress R37–R44, финальная сверка 23 доков.
