...
- [x] [Split.test.ts](../../lib/split/Split.test.ts) — 7 → 31 тест (resize, persist, keyboard, ARIA, overlay, pixel-recalc через mock geometry) · [split.md Issue 2](./split.md). **Цель: 60%/39% → ≥80%/70%** · ✅ resolved 2026-06-06 (достигнуто 85.43% / 70.35%; Split поднят beta → stable)
