...
- [ ] **W3b:** Alert/Dialog/FixWindow (`classBody→class`, `classes.content`, `animated`, `closeOnBackdrop`, `margin`, `teleport`, `strategy`, `openDelay`), Pagination (`pageSize`/`pageSizes`/`visiblePages`, `update:pageSize`), VirtualScroller (`throttle`, `loader`, `setStyle`+options).
