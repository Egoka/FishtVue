...
- [ ] **W7 — типы и barrel:** `VirtualScroller` в `index.d.ts`, `namesColors→ColorName`, `_key→ItemKey`, мёртвые `*Option`, все `PENDING = []` и удаление механизма.
