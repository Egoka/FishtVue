...
| Pagination      | [pagination.md](./pagination.md)           | 0        | 0      | 0      | 0      |
| Badge           | [badge.md](./badge.md)                     | 0        | 3      | 0      | 3      |
| Form            | [form.md](./form.md)                       | 0        | 0      | 0      | 0      |
...
| **TOTAL**       | **27 active + 3 done**                     | **2**    | **62** | **45** | **40** |

Всего **149 active issues** распределены по 27 активным документам аудита (Dialog ✅ 2026-05-11 + FixWindow ✅ 2026-05-16 + Config ✅ 2026-05-20 → перенесены в `./done/`). Прогресс закрытия отслеживается через чекбоксы в Fix roadmap ниже и зачёркнутые блоки внутри каждого `<component>.md`.
