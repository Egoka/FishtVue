...
- [ ] **W9 — sandbox:** `sandbox/` на API 1.0.0 (`pnpm sandbox:build`). `docs/`/`sandbox-nuxt/` — после публикации (R32); codemod — отдельный пакет (R8).
