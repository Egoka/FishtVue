...
updated: 2026-05-10
last-changes: badge — Issues 2, 4, 5 закрыты (Badge-SFC); Issue 1 C17 закрыт per-SFC; Issues 1 packaging/3/6 — cross-cutting, tracked elsewhere; файл перемещён в `./done/`. Roadmap Waves 3.2/10.4/10.6 Badge-checkboxes flipped. utilities — Issues 1, 2, 3, 5, 6, 7, 8, 10, 11 закрыты.
---
...
| **TOTAL**       | **28 files**                               | **17**   | **140** | **105** | **74** |

Всего **336 issues** распределены по 28 documentов аудита (9 закрыты в [\_utilities.md](./done/_utilities.md) 2026-05-10: Issues 1, 2, 3, 5, 6, 7, 8, 10, 11; 3 закрыты в [badge.md](./done/badge.md) 2026-05-10: Issues 2, 4, 5 — файл перемещён в `./done/`, остальные пункты Badge — cross-cutting).
