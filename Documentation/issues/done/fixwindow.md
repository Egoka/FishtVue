...
- **Hardcode цвета (B10):** ✅ resolved 2026-07-05 — структурные нейтральные классы мигрированы на семантический `surface` token (Wave 9, `lib/theme/primitive.ts`, дефолт — точная копия `gray`, см. [theme.md](../../architecture/theme.md)). Мигрированы (family-rename, та же тональность): `border-neutral-200 dark:border-neutral-900` → `border-surface-200 dark:border-surface-900` ([FixWindow.vue:116](../../../lib/fixwindow/FixWindow.vue#L116)); `bg-stone-100 dark:bg-stone-900` (filled) → `bg-surface-100 dark:bg-surface-900` ([:120](../../../lib/fixwindow/FixWindow.vue#L120)); `dark:bg-neutral-950` (outlined, `bg-white` оставлен как есть) → `dark:bg-surface-950` ([:122](../../../lib/fixwindow/FixWindow.vue#L122)); `bg-stone-50 dark:bg-stone-950` (underlined) → `bg-surface-50 dark:bg-surface-950` ([:124](../../../lib/fixwindow/FixWindow.vue#L124)); `text-neutral-800 dark:text-neutral-300` (`classBase`) → `text-surface-800 dark:text-surface-300` ([:133](../../../lib/fixwindow/FixWindow.vue#L133)); `fill-neutral-500 dark:fill-neutral-500` (close-icon) → `fill-surface-500 dark:fill-surface-500` ([:691](../../../lib/fixwindow/FixWindow.vue#L691)). `text-black` (literal) и `text-zinc-600 dark:text-zinc-400` — вне этой миграции, не structural neutrals. Regression: 2 новых теста + обновлён `it.each` mode-class тест в [FixWindow.test.ts](../../../lib/fixwindow/FixWindow.test.ts) (87/87 green). Никаких engine-изменений не потребовалось — `surface` уже полноценный named color с 2026-07-04.
...
| Theme tokens vs hardcode      | ✅          | структурные нейтральные (`border`/`bg`/`text`/`fill`) мигрированы на `surface` token (Wave 9, 2026-07-05); `text-black` (literal) и `text-zinc-*` вне scope |
