...
date: 18/10/2025
seo:
  title: "Menu Component - Navigation Menu for Vue 3"
  description: "Flexible Vue 3 menu component for navigation. Support for nested menus, separators, icons, keyboard navigation, and customizable styling."
  keywords:
    - vue menu
    - navigation menu
    - dropdown menu
