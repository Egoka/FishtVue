...
date: 18/10/2025
seo:
  title: "Pagination Component - Page Navigation for Vue 3"
  description: "Vue 3 pagination component for data navigation. Customizable page numbers, first/last buttons, and jump to page functionality."
  keywords:
    - vue pagination
    - page navigation
