...
date: 18/10/2025
seo:
  title: "Table Component - Advanced Data Table for Vue 3"
  description: "Powerful Vue 3 data table with sorting, filtering, grouping, pagination, and inline editing. Fully customizable and responsive table component."
  keywords:
    - vue table
    - data table
    - table component
