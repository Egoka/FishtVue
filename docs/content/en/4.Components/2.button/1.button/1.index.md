...
date: 18/10/2025
seo:
  title: "Button Component - Customizable Action Buttons for Vue 3"
  description: "Versatile Vue 3 button component with variants, sizes, icons, and loading states. Accessible button with full keyboard support and theming."
  keywords:
    - vue button
    - button component
    - action button
