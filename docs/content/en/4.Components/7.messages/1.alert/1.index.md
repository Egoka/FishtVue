...
date: 18/10/2025
seo:
  title: "Alert Component - Message Notifications for Vue 3"
  description: "Vue 3 alert component for displaying success, error, warning, and info messages. Dismissible alerts with icons and customizable styling."
  keywords:
    - vue alert
