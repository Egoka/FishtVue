...
date: 18/10/2025
seo:
  title: "FixWindow Component - Floating Overlays for Vue 3"
  description: "Create dropdowns, tooltips, and popovers with automatic positioning. Vue 3 floating overlay with collision detection and smart placement."
  keywords:
    - vue fixwindow
    - floating overlay
    - dropdown position
