...
date: 18/10/2025
seo:
  title: "Dialog Component - Modal Overlay for Vue 3"
  description: "Accessible Vue 3 modal dialog with focus trap, keyboard navigation, and customizable overlay. Perfect for alerts, confirmations, and forms."
  keywords:
    - vue dialog
    - modal component
    - overlay
