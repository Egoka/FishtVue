...
date: 18/10/2025
seo:
  title: "Split Component - Resizable Panels for Vue 3"
  description: "Vue 3 split panel component with resizable dividers. Create horizontal and vertical split layouts with drag-to-resize functionality."
  keywords:
    - vue split panel
    - resizable panels
    - split layout
