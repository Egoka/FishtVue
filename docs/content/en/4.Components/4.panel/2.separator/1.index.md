...
date: 18/10/2025
seo:
  title: "Separator Component - Visual Divider for Vue 3"
  description: "Vue 3 separator component for visual content division. Customizable horizontal and vertical dividers with gradients and depth effects."
  keywords:
    - vue separator
    - divider component
    - content divider
