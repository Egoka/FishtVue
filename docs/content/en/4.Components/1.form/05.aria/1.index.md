...
date: 18/10/2025
seo:
  title: "Aria Component - Accessible Input with ARIA Attributes"
  description: "Vue 3 ARIA-compliant input component with full accessibility support, ARIA attributes, and screen reader optimization."
  keywords:
    - aria input
    - accessible input
    - aria attributes
