...
date: 18/10/2025
seo:
  title: "Input API Reference - Complete Props & Events Guide"
  description: "Full API documentation for FishtVue Input component. Props, events, slots, methods, and TypeScript types with examples."
  keywords:
    - input api
    - input props
    - input events
