...
date: 18/10/2025
seo:
  title: "InputLayout API Reference - Props, Events & Slots"
  description: "Complete API reference for FishtVue InputLayout component. Props, emits, slots, exposed methods, and TypeScript types documentation."
  keywords:
    - inputlayout api
    - component api
    - props reference
