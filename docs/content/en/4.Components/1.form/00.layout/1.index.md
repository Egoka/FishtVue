...
date: 18/10/2025
seo:
  title: "InputLayout Component - Form Layout Wrapper for FishtVue"
  description: "Base layout component for form inputs in FishtVue. Learn about labels, validation, error handling, and field management with examples."
  keywords:
    - input layout
    - form layout
    - vue form wrapper
