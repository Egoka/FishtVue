...
date: 18/10/2025
seo:
  title: "Switch API Reference - Toggle Component Documentation"
  description: "Complete API reference for FishtVue Switch component. Props, events, slots, and TypeScript types."
  keywords:
    - switch api
    - toggle api
  ogType: "article"
