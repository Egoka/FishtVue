...
date: 18/10/2025
seo:
  title: "Switch Component - Toggle Switch for Vue 3"
  description: "Accessible Vue 3 switch component for on/off states. Customizable toggle with keyboard support, disabled state, and theming options."
  keywords:
    - vue switch
    - toggle component
    - switch button
