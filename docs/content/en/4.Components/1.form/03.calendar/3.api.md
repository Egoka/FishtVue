...
date: 18/10/2025
seo:
  title: "Calendar API Reference - Complete Date Picker Documentation"
  description: "Full API documentation for FishtVue Calendar component. Props, events, slots, and TypeScript types."
  keywords:
    - calendar api
    - datepicker api
  ogType: "article"
