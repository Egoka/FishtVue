...
date: 18/10/2025
seo:
  title: "Calendar Component - Date Picker for Vue 3"
  description: "Vue 3 calendar and date picker with range selection, min/max dates, disabled dates, and localization. Accessible datepicker component."
  keywords:
    - vue calendar
    - date picker
