...
date: 18/10/2025
seo:
  title: "Select API Reference - Props, Events & Methods"
  description: "Complete API documentation for FishtVue Select component. Props, events, slots, and TypeScript types."
  keywords:
    - select api
    - dropdown api
  ogType: "article"
