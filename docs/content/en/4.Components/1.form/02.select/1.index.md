...
date: 18/10/2025
seo:
  title: "Select Component - Advanced Dropdown for Vue 3"
  description: "Customizable Vue 3 select dropdown with search, multi-select, virtual scroll, and keyboard navigation. Accessible select component with theming."
  keywords:
    - vue select
    - dropdown component
    - multi select
