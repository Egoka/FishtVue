...
date: 18/10/2025
seo:
  title: "Accessibility in FishtVue - WAI-ARIA Compliant Components"
  description: "FishtVue components are built with accessibility first. WCAG 2.0 compliant, WAI-ARIA patterns, keyboard navigation, and screen reader support included."
  keywords:
