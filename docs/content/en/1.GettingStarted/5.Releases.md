...
links:
  - icon: logos:npm-icon
    to: https://www.npmjs.com/package/fishtvue
date: 18/10/2025
seo:
  title: "FishtVue Releases - Version History & Changelog"
  description: "Stay updated with the latest FishtVue releases. View version history, breaking changes, new features, and bug fixes in our comprehensive changelog."
  keywords:
    - fishtvue releases
    - version history
    - changelog
