...
date: 18/10/2025
seo:
  title: "FishtVue Introduction - Modern Vue 3 UI Component Library"
  description: "Discover FishtVue: an open-source, accessible Vue 3 UI component library. Built with TypeScript, focused on customization, accessibility, and developer experience."
  keywords:
    - fishtvue
    - vue 3 components
    - ui library
    ...
    - unstyled components
  ogType: "article"
  ogTitle: "FishtVue - Modern UI Component Library for Vue 3"
  ogDescription: "Build accessible, customizable Vue 3 applications with FishtVue - a developer-friendly UI component library with full TypeScript support."
