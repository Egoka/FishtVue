...
date: 18/10/2025
seo:
  title: "Getting Started with FishtVue - Quick Tutorial"
  description: "Learn how to install and use FishtVue in your Vue 3 project. Step-by-step guide to implement your first component with styling and customization."
  keywords:
    - fishtvue tutorial
