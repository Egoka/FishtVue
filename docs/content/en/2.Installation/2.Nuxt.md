...
date: 18/10/2025
seo:
  title: "Install FishtVue with Nuxt 3 - Module Setup Guide"
  description: "Install FishtVue in your Nuxt 3 project. Complete guide with module configuration, SSR support, auto-imports, and theme customization options."
  keywords:
    - fishtvue nuxt
    - nuxt 3 module
    - nuxt ui library
