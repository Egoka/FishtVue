...
date: 18/10/2025
seo:
  title: "Install FishtVue with Vite - Complete Setup Guide"
  description: "Learn how to install and configure FishtVue in your Vite project. Step-by-step guide with TypeScript support, plugin setup, and theme configuration."
  keywords:
    - fishtvue vite
    - vite installation
    - vue 3 vite setup
    - install ui library vite
