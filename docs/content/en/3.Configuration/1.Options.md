...
date: 18/10/2025
seo:
  title: "FishtVue Configuration - Global Options & Settings"
  description: "Complete guide to FishtVue configuration options. Learn how to customize components globally with prefix, theme settings, and advanced options."
  keywords:
    - fishtvue configuration
    - global options
    - component settings
    - vue ui config
    - theme configuration
