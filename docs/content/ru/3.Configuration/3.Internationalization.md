...
date: 18/10/2025
seo:
  title: "Интернационализация FishtVue (i18n) - Многоязычная поддержка"
  description: "Добавьте многоязычную поддержку в компоненты FishtVue. Настройка локалей, переводов и языковых пакетов для русского, английского и других языков."
  keywords:
    - fishtvue i18n
    - интернационализация
