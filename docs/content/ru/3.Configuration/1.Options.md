...
date: 18/10/2025
seo:
  title: "Конфигурация FishtVue - Глобальные опции и настройки"
  description: "Полное руководство по параметрам конфигурации FishtVue. Научитесь настраивать компоненты глобально с префиксами, темами и расширенными опциями."
  keywords:
    - конфигурация fishtvue
    - глобальные опции
