...
date: 18/10/2025
seo:
  title: "Установка FishtVue с Vite - Полное руководство"
  description: "Узнайте как установить и настроить FishtVue в вашем проекте Vite. Пошаговое руководство с поддержкой TypeScript и настройкой темы."
  keywords:
    - fishtvue vite
    - установка vite
    - vue 3 vite настройка
    - установка ui библиотеки vite
