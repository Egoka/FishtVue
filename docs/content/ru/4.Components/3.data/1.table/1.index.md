...
date: 18/10/2025
seo:
  title: "Компонент Table - Продвинутая таблица данных для Vue 3"
  description: "Мощная таблица данных Vue 3 с сортировкой, фильтрацией, группировкой, пагинацией и редактированием."
  keywords:
    - vue таблица
    - таблица данных
    - сортируемая таблица
