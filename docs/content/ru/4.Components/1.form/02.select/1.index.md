...
date: 18/10/2025
seo:
  title: "Компонент Select - Продвинутый выпадающий список для Vue 3"
  description: "Настраиваемый выпадающий список Vue 3 с поиском, множественным выбором и навигацией с клавиатуры."
  keywords:
    - vue select
    - выпадающий список
    - множественный выбор
