...
date: 18/10/2025
seo:
  title: "Компонент Input - Настраиваемое поле ввода для Vue 3"
  description: "Компонент поля ввода Vue 3 с валидацией, масками, плейсхолдерами и темизацией. Доступное текстовое поле с поддержкой TypeScript."
  keywords:
    - vue компонент input
    - поле ввода
    - текстовое поле
