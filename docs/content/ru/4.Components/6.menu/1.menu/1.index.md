...
date: 18/10/2025
seo:
  title: "Компонент Menu - Навигационное меню для Vue 3"
  description: "Гибкий компонент меню Vue 3 для навигации. Поддержка вложенных меню и навигации с клавиатуры."
  keywords:
    - vue меню
    - навигационное меню
  ogType: "article"
