...
date: 18/10/2025
seo:
  title: "Релизы FishtVue - История версий и список изменений"
  description: "Следите за последними релизами FishtVue. История версий, критические изменения, новые функции и исправления ошибок в подробном changelog."
  keywords:
    - релизы fishtvue
    - история версий
    - список изменений
