...
const EXTERNAL_CORE_DEPENDENCIES = {
  ...
  "textarea/Textarea.vue": "textarea",
...
const RENAME_DEPENDENCIES = {
  ...
  textarea: "textarea/textarea.mjs",
...
const CORE_DEPENDENCIES = JSON.parse(`{
  ...
  "${PROJECT_NAME}/textarea": "${PROJECT_NAME}.textarea",
  "${PROJECT_NAME}/textarea/textarea.mjs": "${PROJECT_NAME}.textarea.textarea.mjs",
...
const COMPOUND_ENTRIES = ["accordion", "table", "menu", "form", "select"]
// @typescript-eslint/no-unused-vars
...
addConfig()
addSFC(`./`)
addEntry("accordion", "index.ts", "accordion") // compound entry: default Accordion + named AccordionItem
...
// addEntry("textarea", "Textarea.vue", "textarea")
