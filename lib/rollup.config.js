...
const EXTERNAL_RENAME_DEPENDENCIES = {
  "dayjs/plugin/isBetween": "dayjs/plugin/isBetween.js"
}
...
const CORE_DEPENDENCIES = JSON.parse(`{
  ...
  "${PROJECT_NAME}/plugins/nuxt": "${PROJECT_NAME}.plugins",
...
const PLUGINS = [
  ...
  typescript({
    ...
    exclude: ["**/doc/**", "**/sandbox/**", "lib/**/*.test.ts"]
  }),
