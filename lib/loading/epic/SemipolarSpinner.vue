<template>
  <div class="semipolar-spinner" :style="spinnerStyle">
    <div v-for="(rs, index) in ringsStyles" :key="index" class="ring-spinner" :style="rs" />
  </div>
</template>
...
<style lang="css">
  ...
  .semipolar-spinner .ring-spinner {
    border-radius: 50%;
    position: absolute;
  ...
  .semipolar-spinner .ring-spinner:nth-child(1) {
  ...
  .semipolar-spinner .ring-spinner:nth-child(2) {
  ...
  .semipolar-spinner .ring-spinner:nth-child(3) {
  ...
  .semipolar-spinner .ring-spinner:nth-child(4) {
  ...
  .semipolar-spinner .ring-spinner:nth-child(5) {
